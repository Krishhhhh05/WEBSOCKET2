...
const GameMenu = ({ socket }: { socket: WebSocket | null }) => {
    ...
    const [players, setPlayers] = useState<{ player1: boolean; player2: boolean; player3: boolean; player4: boolean; player5: boolean; player6: boolean }>({
        player1: false,
        player2: false,
        player3: false,
        player4: false,
                                ...
                                {menuOpen && (
                                    <div className="absolute right-0 mt-2 w-48 bg-[#8F1504] border border-gray-300 rounded shadow-lg">
                                        <div className="p-2">
                                            ...
                                            <button onClick={resetGame} className="bg-red-500 text-white p-2 w-full">
                                                Reset Game
                                            </button>
                                        </div>
                                    </div>
