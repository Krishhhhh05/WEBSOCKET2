...
const Player2Page = () => {
  ...
  useEffect(() => {
    ...
    console.log(" Connected for Player 2");

    ws.onopen = () => {
      console.log(" ✅ WebSocket opened for Player 2");
    };
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      if (data.action === "update_players") {
        setPlayer2Active(data.players.player2);
        console.log("Updated player2 state");
      }
    };
  ...
  return (
    <div>
      {/* <div className="flex font-bold items-center text-3xl justify-center w-full shadow-lg border-2 border-yellow-600">
        Player 2 {player2Active ? "✅ Active" : "❌ Inactive"}
      </div> */}
      {player2Active ? (
